        ...
        <div class="flex items-center justify-between">
            ...
            <nav class="flex transition-all duration-500 z-[5] w-full md:w-1/2 fixed left-0 top-0 h-screen backdrop-blur-xl" :class="{'-translate-x-full' : !isMenuShow}">
                ...
                <div class="flex flex-col gap-6 grow items-center justify-center">
                    ...
                    <NuxtLink to="/gallery" class="relative after:absolute after:left-0 after:-bottom-1 after:w-0 after:h-px after:bg-white after:transition-all after:duration-500 hover:after:w-full"><span class="font-semibold">05</span> Подготовка к полёту</NuxtLink>
                </div>
            </nav>
